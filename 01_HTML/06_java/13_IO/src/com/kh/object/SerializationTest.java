...
public class SerializationTest {
	...
	public void fileSave() {
		...
		//ObjectOutputStream : 객체 단위에 출력시에 사용되는 보조 바이트 스크림 클래스
	...
	// 역직렬화(deserialization) : 저장된 내용이나 전송받는 내용을 다시 복원
	public void fileRead() {
		//1. 스트림 생성
		// FileInputStream : 파일 출력에 사용되는 기본 바이트 스트림 클래스
		// ObjectInputStream : 객체 단위로 출력시에 사용되는 보조 바이트 스크림 클래스
    ...
    public void objectsSave() {
   	 List<Person> list = Arrays.asList(
   			 new Person("카일러 제너", "kyliejenner"),
   			 new Person("드웨인 존슨", "therock"),
   			 new Person("아리아 그란데", "arianagrande")
   			 );
