...
- 서브쿼리의 결과값이 INSERT 문에 지정된 테이블 컬럼의 개수와 
  데이터 타입이 같아야함
...
INSERT INTO EMP_01(EMP_ID, DEPT_TILTE)
VALUES(700, '보안팀');

INSERT INTO EMP_01 (
SELECT EMP_ID, EMP_NAME, DEPT_TITLE, HIRE_DATE -- 순서랑 갯수만 주의
FROM EMPLOYEE
...
-- EMPLOYEE 에서 EMP_NAME이 선동일인 사람의 급여(SALARY)를 7000원, 보너스를 0.2로 변경
...
-- TRUNCATE를 사용해서 사람들 전체 삭제 -> ROLLBACK 적용안됨
