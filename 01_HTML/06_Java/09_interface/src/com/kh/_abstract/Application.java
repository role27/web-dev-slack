...
import com.kh._abstract.step2.PotetoPizza;
import com.kh._abstract.step2.pineapplePizza;

/*
 * 추상클래스(Abstract Class)
 * - 미완성 클래스로 추상 메서드를 포함한 클래스
 * - 미완성 클래스이기 때문에 new 연산자를 통해서 객체 생성x
 * - 일반적인 필드, 메서드 포함(변수 +메서드+추상메서드) 
 * - 객체 생성 할 수 없지만, 참조형 변수 타입으로 사용가능
 * - 상속 관계로 다형성 적용 가능
 * 
...
public class Application {
	...
	public static void main(String[] args) {
		...
		Pizza[] pizza = {
				new BulgogiPizza(27000, "파파존스"),
		        new PotetoPizza(30000,"도미노" ),
		        new pineapplePizza(29000,"피자헛" )};
