...
public class Application {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 수정할 회원의 아이디 : 수정할 이름 : 수정할 이메일 : 수정할 비밀번호 :
		 * 
		 * 3. 전체 회원 정보 출력 -> 반복문 사용해서 끝! 9. 끝내기 -> 프로그램 종료 그 외의 번호 -> 잘못 입력하셨습니다. 다시
		 * 입력해주세요
		 * 
		 * 메뉴 번호 :
		 */
